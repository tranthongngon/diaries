      ...
      <div className="container">
        {diaries.length === 0 && (
          <div className="empty-diary">
            <h2>You haven't written a diary yet</h2>
                ...
                <div className="diary-item" key={index}>
                  <div className="diary-single">
                    ...
                    <div className="diray-thumb">
                      <Link to={`/single-diary/${diary.uid}`}>
      ...
      >
        <div className="dialog-delete">
          <div className="dialog-header">
            <h3>Do you want to delete this diary?</h3>
          </div>
          <div className="dialog-content">
            <p>Data will not be restored once you delete it</p>
          </div>
